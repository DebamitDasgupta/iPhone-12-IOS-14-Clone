$(function(){
  ...
  const globalState = {
    apps: [
      ...
      {
        nombre: 'BGMI',
        icono: 'https://tontonmelayu.com/wp-content/uploads/2021/12/image-2.png',
        type: 'app',
        dinamico: false
      },
      {
      ...
      {
        nombre: 'Fampay',
        icono: 'https://fampay.in/assets/localImages/fampayLogo.png',
        type: 'app',
        dinamico: false
      },
      {
      ...
      {
        nombre: 'Airtle Thanks',
        icono: 'https://s3-ap-southeast-1.amazonaws.com/bsy/iportal/images/airtel-logo-white-text-vertical.jpg',
        type: 'app',
        dinamico: false
      },
      {
      ...
      {
        nombre: 'Amazon',
        icono: 'https://1000logos.net/wp-content/uploads/2016/10/Amazon-logo-meaning.jpg',
        type: 'app',
        dinamico: false
      },
      {
        nombre: 'Instagram',
        icono: 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e7/Instagram_logo_2016.svg/2048px-Instagram_logo_2016.svg.png',
        type: 'app',
        dinamico: false
      },
      {
        nombre: 'redBus',
        icono: 'https://mir-s3-cdn-cf.behance.net/projects/404/2faefe121134065.Y3JvcCwzNDcyLDI3MTYsNTU4LDA.png',
        type: 'app',
        dinamico: false
      },
      {
        nombre: 'Zomato',
        icono: 'https://upload.wikimedia.org/wikipedia/commons/7/75/Zomato_logo.png',
        type: 'app',
        dinamico: false
      },
      {
        nombre: 'Wiz',
        icono: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQBFcq-zmqO-ozYrTSeCrMlo_J1jrF6HjCXQA&usqp=CAU',
        type: 'app',
        dinamico: false
      },
      {
        nombre: 'Upstocks',
        icono: 'https://play-lh.googleusercontent.com/Vikh3F13WxvjDKGoSd7ARmzGCvuVpD5O0tntwi4G3-7UK7je-xXy9Nry83IkQrnyxOs=w240-h480-rw',
        type: 'app',
        dinamico: false
      },
      {
        nombre: 'UBER',
        icono: 'https://play-lh.googleusercontent.com/AQtSF5Sl18yp3mQ2tcbOrBLekb7cyP3kyg5BB1uUuc55zfcnbkCDLHFTBwZfYiu1aDI',
        type: 'app',
        dinamico: false
      },
    ...
    dateTime: {
      meses: ['January', 'February', 'March', 'April', 'may', 'Jun', 'July', 'Agust', 'September', 'October', 'November', 'December'],
      dias: ['Friday', 'Saturday', 'Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday']
    },
    bateriaBaja: false,
    draggScreen: false
  }
...
<div class="manecilla segundos" style="transform: rotate(${transformSegundos});"><div class="barra"></div></div>
    ...
    fecha: function (config) {
      ...
      let dia = globalState.dateTime.dias[config.fecha.getDay()];
      let mes = globalState.dateTime.meses[config.fecha.getMonth()];
      this.text(`${config.diaCompleto ? dia : dia.substring(0, 3)}, ${hoy} of ${mes}`);
      return this;
    },
  })
  ...
  $('.lockScreen').touchMov({
    ...
    movUp: function(e){
      ...
      if (!globalState.bateriaBaja) {
        setTimeout(() => {
          alertaiOS({
            encabezado: 'Please Charge your phone',
            mensaje: 'Low Battery: 10%',
            acciones: [
              {
                texto: 'Ok'
              }
...
<div class="menuOption shaking">Remove
<div class="icono">
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
...
`);
  ...
  $('body').on('click', '.fixedMenuFixedApp .menuOption.eliminar', function () {
    ...
    alertaiOS({
      encabezado: `Transfer ${idApp !== undefined ? globalState.apps[idApp].nombre : 'app'} to another place or delete app?`,
      mensaje: 'Transfering the app will not cause any problem but deleting the app will cause in data loss.',
      acciones: [
        {
          texto: 'Delete app',
          warning: true,
        ...
        {
          texto: 'Transfer app to another place',
  ...
  $('.appScreen').on('click', '.app .removeApp', function () {
    ...
    $('.mainScreen').removeClass('shakingApps');
    alertaiOS({
      encabezado: `Transfer ${idApp !== undefined ? globalState.apps[idApp].nombre : 'app'} to a diffrent place or delete app?`,
      mensaje: 'Transfering the app will not cause any problem but deleting the app will cause in data loss. ',
      acciones: [
        {
          texto: 'Delete app',
        ...
        {
          texto: 'Transfer app to a diffrent place',
          callback: function () { console.log('Biblioteca de apps pendiente') }
        },
        {
          texto: 'Cancel'
